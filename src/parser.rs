...
pub fn parse_value_helper<'a, E: ParseError<&'a str>, O, F1, F2>(f1: F1, f2: F2) -> impl FnMut(&'a str) -> IResult<&'a str, O, E> 
where
...
pub fn parse<'a, E: ParseError<&'a str>>(i: &'a str) -> IResult<&'a str, Vec<Token>, E> {
    let (i, v) = preceded(sp, nom::multi::fold_many1(
...
mod tests {
    ...
    #[test]
    fn pbrt_scenes() {
        let scenes = vec!["./pbrt-v3-scenes/caustic-glass/f16-11a.pbrt",
        ...
        "./pbrt-v3-scenes/sanmiguel/geometry/plantas.pbrt",
